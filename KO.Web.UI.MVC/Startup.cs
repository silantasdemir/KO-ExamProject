...
namespace KO.Web.UI.MVC
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IMemberExamService, MemberExamService>();
            services.AddScoped<IMemberExamDAL, MemberExamDAL>();
            services.AddScoped<IOptionService, OptionService>();
            services.AddScoped<IOptionDAL, OptionDAL>();
